...
public class AddPhoto
{
        ...
        IPhotoService photoService) : IRequestHandler<Command, Result<Photo>>
    {
        public async Task<Result<Photo>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            // A null coalescing operator.  The return value is the left hand side if it is non-null 
            // and the right hand side otherwise.  With an = sign, the right side sill set 
            // user.ImageUrl to photo.Url.
